...
class CommonService {
  ...
  fetchUniformRecommend(tabId: string, page: number): Promise<any> {
    const fullUrl = API.GET_JINGDONG_REPO(
   ...
   * @returns
   */
  fetchBrowseHistory(page: number): Promise<any> {
    const fullUrl = API.GET_JINGDONG_REPO(
   ...
   * @returns
   */
  fetchProductFavorite(page: number): Promise<any> {
    const fullUrl = API.GET_JINGDONG_REPO(
   ...
   * @returns
   */
  fetchOrderList(orderType: string, page: number): Promise<any> {
    const fullUrl = API.GET_JINGDONG_REPO(
  ...
  /// 快手短视频
  fetchKuaiShowVideoList(page: number): Promise<any> {
    const fullUrl = API.GET_JINGDONG_REPO(
