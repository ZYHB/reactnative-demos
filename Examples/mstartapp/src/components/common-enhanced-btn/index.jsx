...
class CommonEnhancedBtn extends Component {
  constructor(props) {
    super(props);
  }

  static displayName = 'CommonEnhancedBtn';
  ...
  _renderContent(children, textStyle) {
    ...
    if (type === 'default' || type === undefined) {
      _color = commonStyle.color.gray;
    } else {
      _color = '#fff';
    }

    if (disabled) {
      _color = this.props.disabledIconColor || commonStyle.color.lightGray;
    }
    ...
    if (typeof children === 'string') {
      return (
        <Text numberOfLines={textNumberOfLines || 1} style={textStyle}>
          {children}
        </Text>
      );
    } else {
  ...
  render() {
    ...
    let {type, size, disabled, shape} = this.props;
...
const styles = StyleSheet.create({
  ...
  banner: {
    borderRadius: 0,
    backgroundColor: commonStyle.color.themeColor,
    margin: 0,
  },
  bannerText: {
    color: 'black',
  ...
  secondary: {
    backgroundColor: commonStyle.color.yellow,
  },
  secondaryText: {
    color: 'black',
    fontSize: 12,
  ...
  bordered: {
    ...
    borderColor: commonStyle.color.themeColor,
    borderWidth: 1,
  },
  borderedText: {
    color: commonStyle.color.themeColor,
    fontSize: 12,
  },
  default: {
    backgroundColor: 'transparent',
  ...
  disabled: {
    borderColor: commonStyle.color.lightGray,
    borderWidth: 1,
    backgroundColor: commonStyle.color.bgColor,
  },
  disabledText: {
    color: commonStyle.color.lightGray,
    fontWeight: 'normal',
  },
  smallCircleSize: {
    height: 25,
