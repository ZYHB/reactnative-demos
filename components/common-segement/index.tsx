...
type Props = {
  ...
  textAtiveStyle?: StyleProp<TextStyle> | undefined;
  textInactiveStyle?: StyleProp<TextStyle> | undefined;
  data: any[];
...
const CommonSegement = (
  ...
  // 设置选中项
  const goToSelectIndex = useCallback((index: number, bl = true) => {
  ...
  }, [layoutInfoMap, data, layoutReady, initialSelectIndex, goToSelectIndex]);
  //暴露指定的方法给父组件调用
